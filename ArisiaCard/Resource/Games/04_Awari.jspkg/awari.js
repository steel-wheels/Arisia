...
async function main() {
    while (1) {
        ...
        d = b[6] - b[13];
        if (d < 0)
            console.print("I WIN BY " + -d + " POINTS\n");
        else if (d == 0) {
            n++;
            console.print("DRAWN GAME\n");
        }
        else {
            n++;
            console.print("YOU WIN BY " + d + " POINTS\n");
        }
    }
}
main();
