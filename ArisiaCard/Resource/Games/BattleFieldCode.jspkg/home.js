...
}
{
    ...
    controls.axis = Axis.horizontal;
    {
        ...
        blue.axis = Axis.vertical;
        {
            ...
            select.axis = Axis.horizontal;
            {
                ...
                button.pressed = function (self) {
                    let url = openPanel("Select machine script", FileType.file, ["js"]);
                    if (url != null) {
        ...
        }
        {
            ...
            count.maxValue = 5;
            count.minValue = 1;
            count.updated = function (self, val) {
