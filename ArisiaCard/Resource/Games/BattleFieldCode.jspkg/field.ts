...
}
{
  ...
  console.width = 40;
  console.height = 5;
  console.main = function(self: root_console_ConsoleViewIF): void {
...
}
{
  ...
  buttons.axis = Axis.horizontal;
  {
    ...
    let start = _alloc_Button() as root_buttons_start_ButtonIF  ;
    /* define type for all properties */
    ...
    /* assign user declared properties */
    start.pressed = function(self: root_buttons_start_ButtonIF): void {
...
let _lfunc_root_buttons_start_title = function(self: root_buttons_start_ButtonIF, paused: boolean): string {
