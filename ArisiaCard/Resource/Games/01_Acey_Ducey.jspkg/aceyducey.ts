...
function getCardValue(card: number): string {
        let result = "?" ;
        if(2<=card && card<=10) {
                result = String(card)
        } else {
...
function main(argv: string[])
{
        ...
        let bet                 : number  = 0 ;
        let availableDollars    : number  = 100;
