...
_definePropertyIF(root, ["table","edit_box","quit_button","axis","alignment","distribution"]) ;
{
  ...
  let table = _alloc_TableView() as root_table_TableViewIF  ;
  /* define type for all properties */
...
{
  /* allocate function for frame: Box */
  let edit_box = _alloc_Box() as root_edit_box_BoxIF  ;
  /* define type for all properties */
  ...
  edit_box.axis = Axis.vertical;
  {
    ...
    let name_label = _alloc_Label() as root_edit_box_name_label_LabelIF  ;
    /* define type for all properties */
  ...
  }
  {
    ...
    let name_field = _alloc_TextField() as root_edit_box_name_field_TextFieldIF  ;
    /* define type for all properties */
  ...
  {
    /* allocate function for frame: Label */
    let site_label = _alloc_Label() as root_edit_box_site_label_LabelIF  ;
    /* define type for all properties */
  ...
  {
    /* allocate function for frame: TextField */
    let site_field = _alloc_TextField() as root_edit_box_site_field_TextFieldIF  ;
    /* define type for all properties */
