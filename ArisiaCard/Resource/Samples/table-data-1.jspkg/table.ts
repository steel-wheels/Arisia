...
_definePropertyIF(root, ["table0","calc_button","quit_button","axis","alignment","distribution"]) ;
{
  ...
  let table0 = _alloc_TableData() as root_table0_TableDataIF  ;
  /* define type for all properties */
...
}
{
  ...
  let calc_button = _alloc_Button() as root_calc_button_ButtonIF  ;
  /* define type for all properties */
  ...
  calc_button.pressed = function(self: root_calc_button_ButtonIF): void {
