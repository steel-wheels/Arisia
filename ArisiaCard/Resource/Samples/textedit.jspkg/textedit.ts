...
_definePropertyIF(root, ["edit","buttons","axis","alignment","distribution"]) ;
{
  ...
  let edit = _alloc_TextEdit() as root_edit_TextEditIF  ;
  /* define type for all properties */
  ...
  edit.main = function(self: root_edit_TextEditIF): void {
...
}
{
  ...
  buttons.axis = Axis.horizontal;
  {
    ...
    let write_button = _alloc_Button() as root_buttons_write_button_ButtonIF  ;
    /* define type for all properties */
    ...
    write_button.pressed = function(self: root_buttons_write_button_ButtonIF): void {
    	  let term = root.edit.terminal ;
              term.string("Hello, ") ;
