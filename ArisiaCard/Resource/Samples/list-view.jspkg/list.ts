...
_definePropertyIF(root, ["list0","buttons","axis","alignment","distribution"]) ;
{
  ...
  let list0 = _alloc_ListView() as root_list0_ListViewIF  ;
  /* define type for all properties */
  ...
  list0.main = function(self: root_list0_ListViewIF): void {
        let items: string[] = [
          "january",
          "february",
          "march",
...
}
{
  ...
  buttons.axis = Axis.horizontal;
  {
    ...
    let edit_button = _alloc_Button() as root_buttons_edit_button_ButtonIF  ;
    /* define type for all properties */
    ...
    edit_button.pressed = function(self: root_buttons_edit_button_ButtonIF): void {
...
let _lfunc_root_list0_slct = function(self: root_list0_ListViewIF, item: string | null): void {

      console.log("selected item = " + item) ;
    } ;
let _lfunc_root_list0_updt = function(self: root_list0_ListViewIF, item: number): void {
