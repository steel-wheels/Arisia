...
interface CollectionDataIF {
  ...
  addItem(p0 : CollectionItemIF): void ;
  addItems(p0 : CollectionItemIF[]): void ;
}
interface CollectionItemIF {
  tag : number ;
  symbol : SymbolIF ;
  title : string ;
}
...
declare function CollectionItem(tag: number, symbol: Symbols, label: String): CollectionItemIF ;
