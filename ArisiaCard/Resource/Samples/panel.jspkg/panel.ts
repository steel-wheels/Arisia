...
_definePropertyIF(root, ["buttons","axis","alignment","distribution"]) ;
{
  ...
  buttons.axis = Axis.vertical;
  {
    ...
    let load_button = _alloc_Button() as root_buttons_load_button_ButtonIF  ;
    /* define type for all properties */
    ...
    load_button.pressed = function(self: root_buttons_load_button_ButtonIF): void {
  ...
  {
    /* allocate function for frame: Button */
    let save_button = _alloc_Button() as root_buttons_save_button_ButtonIF  ;
    /* define type for all properties */
    ...
    save_button.pressed = function(self: root_buttons_save_button_ButtonIF): void {
