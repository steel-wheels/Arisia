...
{
  /* allocate function for frame: Box */
  let consoles = _alloc_Box() as root_consoles_BoxIF  ;
  /* define type for all properties */
  ...
  consoles.axis = Axis.horizontal;
  {
    ...
    let blue = _alloc_ConsoleView() as root_consoles_blue_ConsoleViewIF  ;
    /* define type for all properties */
  ...
  {
    /* allocate function for frame: ConsoleView */
    let green = _alloc_ConsoleView() as root_consoles_green_ConsoleViewIF  ;
    /* define type for all properties */
...
}
{
  ...
  buttons.axis = Axis.horizontal;
  {
    ...
    let hello_button = _alloc_Button() as root_buttons_hello_button_ButtonIF  ;
    /* define type for all properties */
    ...
    hello_button.pressed = function(self: root_buttons_hello_button_ButtonIF): void {
